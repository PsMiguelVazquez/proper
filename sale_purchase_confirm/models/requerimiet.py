...
class ProposalPurchase(models.Model):
    ...
    x_cantidad = fields.Float("Cantidad (Studio)")
    ...
    x_note = fields.Text("Notas (Studio)")
    ...
    x_state = fields.Selection([('draft', 'Borrador'), ('done', 'Propuesta Aceptada'), ('cancel', 'Cancelado'), ('validar', 'Re-Validar'), ('atendido', 'Atendido'), ('confirm', 'Compra Autorizada')], "estado (Studio)", default='draft')
    x_studio_aprovacin_de_compras = fields.Boolean("Aprovación de Compras", related='rel_id.x_order_id.x_aprovacion_compras')
    x_studio_archivo = fields.Binary("Archivo (Studio)")
    ...
    x_studio_text_field_GWDee = fields.Text("Notas (texto Studio)")
    x_terminado = fields.Boolean("Regresar propuesta")
    x_tiempo_entrega = fields.Char("Tiempo de entrega (Studio)")
    x_vigencia = fields.Char("Vigencia (Studio)")
...
class WizarPropo(models.TransientModel):
    ...
    x_cantidad = fields.Char("Cantidad (Studio)")
    x_caracteristicas = fields.Text("Caracteristicas")
    x_categoria_id = fields.Many2one("product.category", "Categoría")
    x_condiciones_de_pago = fields.Char("Condiciones de Pago")
    x_costo = fields.Float("Costo")
    ...
    x_product_id = fields.Many2one("product.product", "producto")
    x_proveedor = fields.Many2one("res.partner", "Proveedor")
    x_proveedor_char = fields.Char("Proveedor (texto)")
