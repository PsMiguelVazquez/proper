...
class Base(models.AbstractModel):
    ...
    def create_or_update_by_external_id(self, vals):
        ...
        def convert_external_2_inner_id(ext_id, field):
            try:
                # MIGRACIÓN V19: `_xmlid_lookup` devolvía (imd_id, model, res_id)
                # en 15.0; en 19.0 devuelve (model, res_id) -> el res_id ahora
                # está en el índice 1, no en el 2.
        ...
        try:
            # MIGRACIÓN V19: idem, res_id ahora en el índice 1.
