                ...
                for moves in self:
                    if moves.sale_line_id.date_planned_line or moves.sale_line_id.date_planned_l:
                        ...
                        if fecha != moves.sale_line_id.date_planned_line or fecha2 != moves.sale_line_id.date_planned_l:
                            fecha_new = fields.datetime(moves.sale_line_id.date_planned_l.year, moves.sale_line_id.date_planned_l.month, moves.sale_line_id.date_planned_l.day) + timedelta(hours=18) if fecha2 else order_id.date_order
